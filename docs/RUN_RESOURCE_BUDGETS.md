...
limit, not a claim about billable tokens. Provider-reported usage may later be recorded for economic
reporting without becoming the authority that decides whether another model call is allowed.
